...
from tensorflow.contrib.rnn import BasicRNNCell, LSTMCell, GRUCell, BasicLSTMCell
...
class RecurrentModel(object):
    ...
    def __init__(self, model_name: str, cell: Union[BasicRNNCell, BasicLSTMCell, GRUCell] = None,
                 learning_rate: float = 1e-3, batch_size: int = 5, num_nodes: int = None, seq_len: int = 40,
                 input_dim: int = 2, output_dim: int = 2, restore: bool = False):
        if num_nodes is None or cell is None:
            raise ValueError('Please Specific the Number of Nodes and Cell Type.')
